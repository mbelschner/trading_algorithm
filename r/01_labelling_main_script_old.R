...
source("r/01_01_triple_barrier_labeling_optimized_old.R")  # Main labeling function
source("r/01_02_triple_barrier_labeling_helpers_old.R")    # Helper functions (includes filtering)
...
STANDARD_ATR_PERIOD = 12
STANDARD_MAX_HORIZON = 16
STANDARD_NEUTRAL_THRESHOLD = 1.5
STANDARD_ATR_MULT = 2.5
